...
int CamIicSetupPicFormat(u32 lIicBaseAddress, u32 fOptions) {
	...
	switch (fOptions) {
		...
		default: //CAM_CFG_1280x720P
			...
			CamIicSingleWrite(lIicBaseAddress, 0x33900000);	// = 0
			CamIicSingleWrite(lIicBaseAddress, 0x338C2765);
			// Mode Var: crop_Y1_B (R0x0065)
			CamIicSingleWrite(lIicBaseAddress, 0x339002D0);	// = 720
			...
			// LINE ADDED HERE
			//CamIicSingleWrite(lIicBaseAddress, 0x338C2797);
			//CamIicSingleWrite(lIicBaseAddress, 0x33900030);
			break;
	}	
